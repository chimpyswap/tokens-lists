...
expect.extend({
  ...
  toBeValidLogo(token) {
    ...
    const refersToLocalLogo =
      token.logoURI === `https://tokens.chimpyswap.com/images/${token.address}.png` ||
      token.logoURI === `https://tokens.chimpyswap.com/images/${token.address.toLowerCase()}.png`;
    if (token.logoURI === "https://tokens.chimpyswap.com/images/0x4e6415a5727ea08aae4580057187923aec331227.png") {
